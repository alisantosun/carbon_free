...
tab_result.markdown(f"""You owe nature Karbon ayak izinizi düşürmek için aşağıdaki önerileri göz önünde bulundurabilirsiniz <b>{tree_count}</b> tree{'s' if tree_count > 1 else ''} monthly. <br> {f"<a href='https://www.tema.org.tr/fidan-bagisi-secenekleri/genel-amacli-sertifika-ingilizce' id = 'button-17' class='button-17' role='button'> 🌳 Proceed to offset 🌳</a>" if tree_count > 0 else ""}""",  unsafe_allow_html=True)
